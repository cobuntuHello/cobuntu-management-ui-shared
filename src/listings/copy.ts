...
export const LISTING_DETAIL_COPY: Record<string, string> = {
    ...
    /* Fee lines + payout timing/destination. */
    ledgerFeeVat: "VAT",
    ledgerFeeStripe: "Stripe fee",
    ledgerFeeStripeAbsorbed: "Absorbed by Cobuntu",
    ledgerFeeCobuntu: "Cobuntu fee",
    ledgerFeeCommunity: "Community commission",
    ledgerScheduledFor: "fires {date}",
    ledgerPaidTo: "to {account}",
    ledgerShowBreakdown: "Fee breakdown",
